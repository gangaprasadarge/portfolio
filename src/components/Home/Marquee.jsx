...
import { IoLogoCss3, IoLogoHtml5, IoLogoPython } from "react-icons/io5";
import { SiMicrosoftexcel, SiPostgresql, SiPostman, SiPowerbi, SiTableau } from "react-icons/si";
...
const data = [
  ...
  {
    title: "CSS",
    tag: "Style Sheet Language",
    icon: <IoLogoCss3 className="text-5xl" />,
  },
  {
    title: "SQL",
    tag: "Database Query Language",
    icon: <SiPostgresql className="text-5xl" />,
  },
  {
    title: "Power BI",
    tag: "Data Visualization Tool",
    icon: <SiPowerbi className="text-5xl" />,
  },
  {
    title: "Tableau",
    tag: "Data Visualization Tool",
    icon: <SiTableau className="text-5xl" />,
  },
  {
    title: "Excel",
    tag: "Spreadsheet Software",
    icon: <SiMicrosoftexcel className="text-5xl" />,
  },
  {
    title: "Java",
  ...
  },
  {
    title: "Python",
    tag: "Programming Language",
    icon: <IoLogoPython className="text-5xl" />,
  },
];
